    ...
    return (
        <div className="bg-slate-100 content-wrapper px-lg-5 px-3">
            <div className='flex justify-evenly items-center mb-6'>
                ...
                <Link to='/alo24/status' className='bg-sky-500 flex justify-center items-center py-2 px-4 w-[300px] h-[150px] text-[20px] rounded-xl shadow-2xl text-white font-bold text-uppercase'>{t("STATUS")}</Link>
            </div>
