    ...
    return (
            ...
            <div>
                ...
                <div className="flex justify-between items-center">
                    <div>
                        <strong style={{ color: "black", fontSize: '12px', fontFamily: 'times' }}>
                            Manzil:{' '}
                        </strong>
                    </div>
                    <div style={{ fontWeight: "bold", color: "black", fontSize: '12px', fontFamily: 'times' }}>
                ...
                {connector.probirka && <div className="flex justify-between items-center">
                    <div>
                        <strong style={{ color: "black", fontSize: '14px', fontFamily: 'times' }}>
                            Namuna:{' '}
                        </strong>
                    </div>
                    <div style={{ fontWeight: "bold", color: "black", fontSize: '14px', fontFamily: 'times' }}>
                ...
                <div
                    className="border-2 border-black-800 p-1 mt-2 flex justify-between items-center text-[16px] font-bold"
                >
                    <div>Jami:</div>
                    <div>
                        {connector.products &&
