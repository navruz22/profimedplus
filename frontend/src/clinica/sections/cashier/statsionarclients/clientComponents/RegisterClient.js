                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <table className="table">
                                <thead>
                                    <tr>
                                        <th scope="col" className="border bg-alotrade py-1">
                                            #
                                        </th>
                                        <th scope="col" className="border bg-alotrade py-1">
                                            First
                                ...
                                <div className="col-12">
                                    <table className="table table-sm border-collapse">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="border py-1 font-bold"> {t("Xona")}</td>
                                                ...
                                                <td className="border py-1 text-right font-bold"> {room.day} {t("kun")}
                                                </td>
                                    ...
                                    <div>
                                        <button
                                            ...
                                            className="bg-alotrade py-1 px-3 text-white rounded-sm float-right hover:bg-teal-600 d-inline-block">
